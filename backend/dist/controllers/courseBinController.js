...
import { addOrUpdateCourseBinItem, getCourseBinForStudent, removeCourseBinItem, } from "../services/courseBinService.js";
...
function parseUpsertBody(body) {
    ...
    if (!course_code || !section)
        return null;
    const registered_display = typeof o.registered_display === "string"
        ? o.registered_display
        : typeof o.registered === "string"
            ? o.registered
            : null;
    const time_display = typeof o.time_display === "string"
        ? o.time_display
        : typeof o.time === "string"
            ? o.time
            : null;
    const days_display = typeof o.days_display === "string"
        ? o.days_display
...
export async function getCourseBin(req, res) {
    try {
...
export async function postCourseBin(req, res) {
    try {
...
export async function deleteCourseBinItemHandler(req, res) {
    try {
...
//# sourceMappingURL=courseBinController.js.map