import { getAccountingLedgerPayload, getAccountingQuartersPayload, } from "../services/studentLedgerService.js";
...
export async function getAccountingQuarters(req, res) {
    try {
...
export async function getAccountingLedger(req, res) {
    try {
        const studentId = pathStudentId(req);
...
//# sourceMappingURL=studentLedgerController.js.map