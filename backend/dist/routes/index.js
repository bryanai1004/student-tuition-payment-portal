...
import { getAdminStudentAcademicRecords, getAdminStudent, getAdminStudentRegistrationTerms, getAdminStudentPhotoUrlHandler, getAdminStudents, getNextAdminStudentId, postExportAdminStudentsCsv, postAdminStudentPhoto, postAdminStudent, postAdminStudentLoa, postDeleteSelectedAdminStudents, putAdminStudent, uploadAdminStudentPhotoMiddleware, } from "../controllers/adminStudentController.js";
import { deleteAdminCourseSection, getAdminCourseSectionCourseMeta, getAdminCourseSectionEnrollments, getAdminCourseSectionRosterHandler, getAdminExportFeedbackCsv, getAdminCourseSections, getAdminExportRegisteredStudentsCsv, patchAdminCourseSection, postAdminCourseSection, } from "../controllers/adminCourseSectionController.js";
...
import { getAuthorizeClinicFeeSummaryHandler, getAuthorizeCurrentTermSummaryHandler, getAuthorizeTuitionSummaryHandler, postAuthorizeNetClinicFeeChargeHandler, postAuthorizeNetChargeHandler, postAuthorizeNetTuitionChargeHandler, } from "../controllers/studentAuthorizePaymentController.js";
...
import { postAdminClinicalSlotAddStudentHandler, deleteAdminClinicalSlotEnrollmentHandler, deleteStudentClinicalEnrollmentHandler, getAdminClinicalSlotRosterHandler, getStudentClinicalEnrollmentsHandler, getStudentOpenClinicalEnrollmentSlotsHandler, postAdminClinicalSlotStudentHandler, postAdminClinicalSlotEnrollmentGradeHandler, postAdminClinicalPaymentHoldCleanupHandler, postStudentClinicalEnrollmentHandler, } from "../controllers/clinicalEnrollmentController.js";
...
import { getAdminClinicalExamRequestsHandler, getStudentClinicalExamRequestsHandler, postAdminClinicalExamRequestAssignHandler, postStudentClinicalExamRequestHandler, } from "../controllers/clinicalExamRequestController.js";
...
apiRouter.post("/payments/authorize/clinic-fee-charge", postAuthorizeNetClinicFeeChargeHandler);
apiRouter.get("/payments/authorize/current-term-summary", getAuthorizeCurrentTermSummaryHandler);
apiRouter.get("/payments/authorize/tuition-summary", getAuthorizeTuitionSummaryHandler);
apiRouter.get("/payments/authorize/clinic-fee-summary", getAuthorizeClinicFeeSummaryHandler);
...
apiRouter.post("/student/me/photo", uploadStudentMyPhotoMiddleware, postStudentMyPhotoHandler);
...
adminRouter.post("/students/:studentId/photo", uploadAdminStudentPhotoMiddleware, postAdminStudentPhoto);
adminRouter.get("/students/:studentId/photo-url", getAdminStudentPhotoUrlHandler);
adminRouter.get("/students/:studentId/registration-terms", getAdminStudentRegistrationTerms);
adminRouter.get("/students/:studentId/academic-records", getAdminStudentAcademicRecords);
adminRouter.get("/students/:studentId/clinical-progress", getAdminStudentClinicalProgressHandler);
...
adminRouter.get("/sections/:sectionId/roster", getAdminCourseSectionRosterHandler);
...
adminRouter.delete("/finance/payment/:id", deleteAdminFinancePaymentByIdHandler);
...
adminRouter.post("/clinical/slots/:timetableId/add-student", postAdminClinicalSlotAddStudentHandler);
...
adminRouter.post("/clinical/requests/:id/approve", postApproveClinicalRequestHandler);
adminRouter.post("/clinical/requests/:id/reject", postRejectClinicalRequestHandler);
adminRouter.get("/clinical/exam-requests", getAdminClinicalExamRequestsHandler);
adminRouter.post("/clinical/exam-requests/:id/assign", postAdminClinicalExamRequestAssignHandler);
adminRouter.get("/students/:studentId/documents", getAdminStudentDocumentRequirementsHandler);
adminRouter.post("/students/:studentId/documents/reset-all", postAdminStudentDocumentRequirementsResetAllHandler);
adminRouter.post("/students/:studentId/documents/:requirementType/reset", postAdminStudentDocumentRequirementResetHandler);
apiRouter.use("/admin", adminRouter);
apiRouter.get("/students/:studentId/documents", getStudentDocumentRequirementsHandler);
apiRouter.post("/students/:studentId/documents/agreement/submit", postStudentAgreementSubmitHandler);
apiRouter.post("/students/:studentId/documents/quizzes/:quizId/submit", postStudentQuizSubmitHandler);
...
apiRouter.get("/students/:studentId/clinical-schedule", getStudentClinicalScheduleHandler);
apiRouter.get("/students/:studentId/clinical-enrollments/open", getStudentOpenClinicalEnrollmentSlotsHandler);
apiRouter.get("/students/:studentId/clinical-enrollments", getStudentClinicalEnrollmentsHandler);
apiRouter.post("/students/:studentId/clinical-enrollments", postStudentClinicalEnrollmentHandler);
apiRouter.delete("/students/:studentId/clinical-enrollments/:enrollmentId", deleteStudentClinicalEnrollmentHandler);
apiRouter.post("/students/:studentId/clinical-requests", postStudentClinicalRequestHandler);
apiRouter.get("/students/:studentId/clinical-requests", getStudentClinicalRequestsHandler);
