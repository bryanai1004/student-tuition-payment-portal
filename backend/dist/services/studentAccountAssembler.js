...
import { buildEnrollmentLineItems, buildInstallmentSchedule, buildScheduleRows, buildStudentAccountSummary, calculateInstallmentServiceFee, getInstallmentPlanPolicyText, mergeStandardFeesAndInstallmentFee, } from "./billingMath.js";
...
export function assembleStudentAccountPayload(ctx, options) {
    ...
    const instCount = pref.useInstallmentPlan
        ...
        : 1;
    const installmentSchedule = buildInstallmentSchedule(summary.outstandingBalance, pref.useInstallmentPlan ? instCount : 1, DEFAULT_INSTALLMENT_DUE_DATES);
    ...
    return {
        ...
        termChargeEffectiveDate: options?.termChargeEffectiveDate ?? "2026-08-15",
    };
}
//# sourceMappingURL=studentAccountAssembler.js.map