...
import {
  approveClinicalRequestById,
  createStudentClinicalRequest,
  listAdminPendingClinicalRequestsApi,
  listStudentClinicalRequestsApi,
  rejectClinicalRequestById,
} from "../services/clinicalRequestService.js";
...
function readOptionalDecidedBy(
...
function pathRequestId(req: Request): number {
 ...
 * Body: { timetableId }
 */
export async function postStudentClinicalRequestHandler(
  req: Request,
  res: Response,
): Promise<void> {
  try {
 ...
 */
export async function getStudentClinicalRequestsHandler(
  req: Request,
  res: Response,
): Promise<void> {
  try {
 ...
 */
export async function getAdminClinicalRequestsHandler(
  _req: Request,
  res: Response,
): Promise<void> {
  try {
 ...
 */
export async function postApproveClinicalRequestHandler(
  req: Request,
  res: Response,
): Promise<void> {
  try {
 ...
 */
export async function postRejectClinicalRequestHandler(
  req: Request,
  res: Response,
): Promise<void> {
  try {
